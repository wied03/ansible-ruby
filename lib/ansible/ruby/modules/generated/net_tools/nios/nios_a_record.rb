  ...
  module Ruby
    module Modules
      ...
      class Nios_a_record < Base
        ...
        # @return [Object] Configures the IPv4 address for this A record.
        attribute :ipv4addr
        validates :ipv4addr, presence: true

        # @return [Object, nil] Configures the TTL to be associated with this A record
        attribute :ttl
