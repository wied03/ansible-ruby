  ...
  module Ruby
    module Modules
      ...
      class Win_copy < Base
        ...
        # @return [String, nil] This option controls the autodecryption of source files using vault.
        attribute :decrypt
        validates :decrypt, type: String
        ...
        # @return [String, nil] If C(no), it will search for src at originating/master machine.,If C(yes), it will go to the remote/target machine for the src.
