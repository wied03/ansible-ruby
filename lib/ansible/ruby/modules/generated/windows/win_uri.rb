  ...
  module Ruby
    module Modules
      ...
      class Win_uri < Base
        ...
        # @return [Object, nil] A filename, when it already exists, this step will be skipped.
        attribute :creates

        # @return [Object, nil] A filename, when it does not exist, this step will be skipped.
        attribute :removes
        ...
        # @return [Object, nil] Specifies the client certificate (.pfx) that is used for a secure web request.,The WinRM connection must be authenticated with C(CredSSP) if the certificate file is not password protected.,Other authentication types can set I(client_cert_password) when the cert is password protected.
