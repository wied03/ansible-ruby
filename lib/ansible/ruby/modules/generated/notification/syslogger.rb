  ...
  module Ruby
    module Modules
      ...
      class Syslogger < Base
        ...
        attribute :priority
        validates :priority, inclusion: {:in=>[:emerg, :alert, :crit, :err, :warning, :notice, :info, :debug], :message=>"%{value} needs to be :emerg, :alert, :crit, :err, :warning, :notice, :info, :debug"}, allow_nil: true
