  ...
  module Ruby
    module Modules
      ...
      class Gcp_sql_instance < Base
        ...
        validates :backend_type, inclusion: {:in=>[:FIRST_GEN, :SECOND_GEN, :EXTERNAL], :message=>"%{value} needs to be :FIRST_GEN, :SECOND_GEN, :EXTERNAL"}, allow_nil: true
        ...
        validates :database_version, inclusion: {:in=>[:MYSQL_5_5, :MYSQL_5_6, :MYSQL_5_7, :POSTGRES_9_6], :message=>"%{value} needs to be :MYSQL_5_5, :MYSQL_5_6, :MYSQL_5_7, :POSTGRES_9_6"}, allow_nil: true
        ...
        validates :instance_type, inclusion: {:in=>[:CLOUD_SQL_INSTANCE, :ON_PREMISES_INSTANCE, :READ_REPLICA_INSTANCE], :message=>"%{value} needs to be :CLOUD_SQL_INSTANCE, :ON_PREMISES_INSTANCE, :READ_REPLICA_INSTANCE"}, allow_nil: true
