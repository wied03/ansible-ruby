  ...
  module Ruby
    module Modules
      ...
      class Gcp_compute_http_health_check < Base
        ...
        # @return [Object, nil] The value of the host header in the HTTP health check request. If left empty (default value), the public IP on behalf of which this health check is performed will be used.
        attribute :host
        ...
        # @return [Integer, nil] The TCP port number for the HTTP health check request.,The default value is 80.
        attribute :port
        validates :port, type: Integer

        # @return [Object, nil] The request path of the HTTP health check request.,The default value is /.
