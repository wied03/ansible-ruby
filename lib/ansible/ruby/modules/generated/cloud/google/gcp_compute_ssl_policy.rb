  ...
  module Ruby
    module Modules
      ...
      class Gcp_compute_ssl_policy < Base
        ...
        attribute :profile
        validates :profile, inclusion: {:in=>[:COMPATIBLE, :MODERN, :RESTRICTED, :CUSTOM], :message=>"%{value} needs to be :COMPATIBLE, :MODERN, :RESTRICTED, :CUSTOM"}, allow_nil: true
        ...
        validates :min_tls_version, inclusion: {:in=>[:TLS_1_0, :TLS_1_1, :TLS_1_2], :message=>"%{value} needs to be :TLS_1_0, :TLS_1_1, :TLS_1_2"}, allow_nil: true
