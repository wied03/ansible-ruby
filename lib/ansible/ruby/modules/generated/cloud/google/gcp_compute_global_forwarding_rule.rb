...
module Ansible
  module Ruby
    module Modules
      ...
      class Gcp_compute_global_forwarding_rule < Base
        ...
        # @return [String, nil] This target must be a global load balancing resource. The forwarded traffic must be of a type appropriate to the target object.,Valid types: HTTP_PROXY, HTTPS_PROXY, SSL_PROXY, TCP_PROXY .
        attribute :target
