...
module Ansible
  module Ruby
    module Modules
      ...
      class Gce_net < Base
        # @return [String, nil] the protocol:ports to allow ('tcp:80' or 'tcp:80,443' or 'tcp:80-800;udp:1-25') this parameter is mandatory when creating or updating a firewall rule
        attribute :allowed
        ...
        # @return [Array<String>, String, nil] the source IPv4 address range in CIDR notation
        attribute :src_range
        validates :src_range, type: TypeGeneric.new(String)
