  ...
  module Ruby
    module Modules
      ...
      class Pubnub_blocks < Base
        ...
        # @return [Object, nil] Name of PubNub account for from which C(application) will be used to manage blocks.,user account
        attribute :account
        ...
        # @return [String, nil] Short block description which will be later visible on admin.pubnub.com description for existing block.
