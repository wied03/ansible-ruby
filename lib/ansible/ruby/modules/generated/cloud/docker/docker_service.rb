  ...
  module Ruby
    module Modules
      ...
      class Docker_service < Base
        ...
        validates :dependencies, inclusion: {:in=>[:yes, :no], :message=>"%{value} needs to be :yes, :no"}, allow_nil: true
        ...
        validates :hostname_check, inclusion: {:in=>[:yes, :no], :message=>"%{value} needs to be :yes, :no"}, allow_nil: true
        ...
        attribute :nocache
        validates :nocache, inclusion: {:in=>[:yes, :no], :message=>"%{value} needs to be :yes, :no"}, allow_nil: true
        ...
        validates :remove_volumes, inclusion: {:in=>[:yes, :no], :message=>"%{value} needs to be :yes, :no"}, allow_nil: true

        # @return [:yes, :no, nil] Use with state I(present) to leave the containers in an exited or non-running state.
        attribute :stopped
        validates :stopped, inclusion: {:in=>[:yes, :no], :message=>"%{value} needs to be :yes, :no"}, allow_nil: true

        # @return [:yes, :no, nil] Use with state I(present) to restart all containers.
        attribute :restarted
        validates :restarted, inclusion: {:in=>[:yes, :no], :message=>"%{value} needs to be :yes, :no"}, allow_nil: true
