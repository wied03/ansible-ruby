  ...
  module Ruby
    module Modules
      ...
      class Docker_container < Base
        ...
        # @return [Array<String>, String, nil] Command to execute when the container starts.
        attribute :command
        ...
        # @return [:none, :"json-file", :syslog, :journald, :gelf, :fluentd, :awslogs, :splunk, nil] Specify the logging driver. Docker uses json-file by default.
        attribute :log_driver
        validates :log_driver, inclusion: {:in=>[:none, :"json-file", :syslog, :journald, :gelf, :fluentd, :awslogs, :splunk], :message=>"%{value} needs to be :none, :\"json-file\", :syslog, :journald, :gelf, :fluentd, :awslogs, :splunk"}, allow_nil: true
