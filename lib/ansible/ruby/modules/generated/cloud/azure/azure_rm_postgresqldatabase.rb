  ...
  module Ruby
    module Modules
      ...
      class Azure_rm_postgresqldatabase < Base
        ...
        # @return [String, nil] When set to C(true), will delete and recreate the existing PostgreSQL database if any of the properties don't match what is set.,When set to C(false), no change will occur to the database even if any of the properties do not match.
