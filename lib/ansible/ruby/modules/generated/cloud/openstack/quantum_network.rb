  ...
  module Ruby
    module Modules
      ...
      class Quantum_network < Base
        ...
        # @return [Integer, nil] The id that has to be assigned to the network, in case of vlan networks that would be vlan id and for gre the tunnel id
        attribute :provider_segmentation_id
        validates :provider_segmentation_id, type: Integer
