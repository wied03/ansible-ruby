  ...
  module Ruby
    module Modules
      ...
      class Ecs_taskdefinition < Base
        ...
        # @return [:bridge, :host, :none, nil] The Docker networking mode to use for the containers in the task.
        attribute :network_mode
        validates :network_mode, inclusion: {:in=>[:bridge, :host, :none], :message=>"%{value} needs to be :bridge, :host, :none"}, allow_nil: true
