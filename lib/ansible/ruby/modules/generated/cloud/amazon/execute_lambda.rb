  ...
  module Ruby
    module Modules
      ...
      class Execute_lambda < Base
        ...
        attribute :tail_log
        validates :tail_log, inclusion: {:in=>[:yes, :no], :message=>"%{value} needs to be :yes, :no"}, allow_nil: true
        ...
        attribute :dry_run
        validates :dry_run, inclusion: {:in=>[:yes, :no], :message=>"%{value} needs to be :yes, :no"}, allow_nil: true
