  ...
  module Ruby
    module Modules
      ...
      class Ec2_asg_lifecycle_hook < Base
        ...
        validates :transition, presence: true, inclusion: {:in=>[:"autoscaling:EC2_INSTANCE_TERMINATING", :"autoscaling:EC2_INSTANCE_LAUNCHING"], :message=>"%{value} needs to be :\"autoscaling:EC2_INSTANCE_TERMINATING\", :\"autoscaling:EC2_INSTANCE_LAUNCHING\""}
        ...
        validates :default_result, inclusion: {:in=>[:ABANDON, :CONTINUE], :message=>"%{value} needs to be :ABANDON, :CONTINUE"}, allow_nil: true
      end
    end
  end
end
