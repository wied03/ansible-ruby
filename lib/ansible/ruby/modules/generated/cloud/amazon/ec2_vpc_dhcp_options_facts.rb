...
module Ansible
  module Ruby
    module Modules
      ...
      class Ec2_vpc_dhcp_options_facts < Base
        ...
        # @return [String, nil] Get details of specific DHCP Option ID,Provide this value as a list
        attribute :DhcpOptionsIds
        validates :DhcpOptionsIds, type: String
      end
    end
  end
end
