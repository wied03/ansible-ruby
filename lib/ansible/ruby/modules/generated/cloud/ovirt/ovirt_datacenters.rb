...
module Ansible
  module Ruby
    module Modules
      ...
      class Ovirt_datacenters < Base
        # @return [String] Name of the the data center to manage.
        attribute :name
        ...
        # @return [Object, nil] MAC pool to be used by this datacenter.,IMPORTANT: This option is deprecated in oVirt 4.1. You should use C(mac_pool) in C(ovirt_clusters) module, as MAC pools are set per cluster since 4.1.
        attribute :mac_pool
      end
    end
  end
