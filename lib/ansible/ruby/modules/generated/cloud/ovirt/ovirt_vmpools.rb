...
module Ansible
  module Ruby
    module Modules
      ...
      class Ovirt_vmpools < Base
        # @return [String] Name of the the VM pool to manage.
        attribute :name
        ...
        attribute :type
        validates :type, inclusion: {:in=>[:manual, :automatic], :message=>"%{value} needs to be :manual, :automatic"}, allow_nil: true
