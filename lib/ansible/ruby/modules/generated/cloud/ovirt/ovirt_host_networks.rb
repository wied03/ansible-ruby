...
module Ansible
  module Ruby
    module Modules
      ...
      class Ovirt_host_networks < Base
        # @return [String] Name of the the host to manage networks for.
        attribute :name
        ...
        # @return [Hash, nil] Dictionary describing network bond:,C(name) - Bond name.,C(mode) - Bonding mode.,C(interfaces) - List of interfaces to create a bond.
        attribute :bond
