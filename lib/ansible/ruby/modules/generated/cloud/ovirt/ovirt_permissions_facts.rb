...
module Ansible
  module Ruby
    module Modules
      ...
      class Ovirt_permissions_facts < Base
        # @return [String, nil] Username of the the user to manage. In most LDAPs it's I(uid) of the user, but in Active Directory you must specify I(UPN) of the user.
        attribute :user_name
        validates :user_name, type: String

        # @return [Object, nil] Name of the the group to manage.
