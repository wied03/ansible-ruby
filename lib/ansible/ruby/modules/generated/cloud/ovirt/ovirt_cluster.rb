  ...
  module Ruby
    module Modules
      ...
      class Ovirt_cluster < Base
        ...
        validates :migration_policy, inclusion: {:in=>[:legacy, :minimal_downtime, :suspend_workload, :post_copy], :message=>"%{value} needs to be :legacy, :minimal_downtime, :suspend_workload, :post_copy"}, allow_nil: true
