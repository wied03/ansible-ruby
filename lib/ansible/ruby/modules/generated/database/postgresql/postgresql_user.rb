  ...
  module Ruby
    module Modules
      ...
      class Postgresql_user < Base
        ...
        # @return [String, NilClass, nil] set the user's password, before 1.4 this was required.,When passing an encrypted password, the encrypted parameter must also be true, and it must be generated with the format in the Ansible docs
        attribute :password
        validates :password, type: MultipleTypes.new(String, NilClass)
