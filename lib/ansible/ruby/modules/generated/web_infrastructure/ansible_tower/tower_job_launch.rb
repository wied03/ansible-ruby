  ...
  module Ruby
    module Modules
      ...
      class Tower_job_launch < Base
        # @return [String] Name of the job_template to use.
        ...
        # @return [Object, nil] Extra_vars to use for the job_template. Use '@' for a file.
        attribute :extra_vars

        # @return [Object, nil] Limit to use for the job_template.
        attribute :limit

        # @return [Object, nil] Specific tags to use for from playbook.
        attribute :tags

        # @return [Boolean, nil] Disable launching jobs from job template.
        attribute :use_job_endpoint
        validates :use_job_endpoint, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
      end
    end
  end
end
