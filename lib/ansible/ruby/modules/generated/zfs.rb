  ...
  module Ruby
    module Modules
      class Zfs < Base
        ...
        # @return [String] Whether to create (C(present)), or remove (C(absent)) a file system, snapshot or volume. All parents/children will be created/destroyed as needed to reach the desired state.
        attribute :state
