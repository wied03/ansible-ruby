  ...
  module Ruby
    module Modules
      class Azure_rm_storageaccount < Base
        ...
        # @return [String] Assert the state of the storage account. Use 'present' to create or update a storage account and 'absent' to delete an account.
        attribute :state
        ...
        # @return [Object] Type of storage account. Required when creating a storage account. NOTE: Standard_ZRS and Premium_LRS accounts cannot be changed to other account types, and other account types cannot be changed to Standard_ZRS or Premium_LRS.
        ...
        # @return [String] The 'kind' of storage.
        attribute :kind
