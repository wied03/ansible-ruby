  ...
  module Ruby
    module Modules
      ...
      class Find < Base
        ...
        # @return [:file, :directory, :link, :any, nil] Type of file to select,The 'link' and 'any' choices were added in version 2.3
        attribute :file_type
        validates :file_type, inclusion: {:in=>[:file, :directory, :link, :any], :message=>"%{value} needs to be :file, :directory, :link, :any"}, allow_nil: true
