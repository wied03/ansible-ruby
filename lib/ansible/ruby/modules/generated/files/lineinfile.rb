  ...
  module Ruby
    module Modules
      ...
      class Lineinfile < Base
        ...
        # @return [String, nil] Used with C(insertafter) or C(insertbefore). If set, C(insertafter) and C(inserbefore) find a first line has regular expression matches.
        attribute :firstmatch
        validates :firstmatch, type: String
