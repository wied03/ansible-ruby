  ...
  module Ruby
    module Modules
      class Puppet < Base
        ...
        # @return [String, nil] The hostname of the puppetmaster to contact.
        ...
        # @return [String, nil] A dict of values to pass in as persistent external facter facts
        attribute :facts
        ...
        # @return [String, nil] A comma-separated list of puppet tags to be used.
        attribute :tags
