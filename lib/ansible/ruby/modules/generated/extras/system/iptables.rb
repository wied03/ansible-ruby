  ...
  module Ruby
    module Modules
      ...
      class Iptables < Base
        ...
        # @return [Object, nil] ctstate is a list of the connection states to match in the conntrack module. Possible states are: 'INVALID', 'NEW', 'ESTABLISHED', 'RELATED', 'UNTRACKED', 'SNAT', 'DNAT'
        attribute :ctstate
