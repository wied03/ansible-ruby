  ...
  module Ruby
    module Modules
      class Solaris_zone < Base
        ...
        # @return [Object, nil] The path where the zone will be created. This is required when the zone is created, but not used otherwise.
        attribute :path

        # @return [Object, nil] Whether to create a sparse (C(true)) or whole root (C(false)) zone.
        attribute :sparse

        # @return [Object, nil] The password hash for the root account. If not specified, the zone's root account will not have a password.
