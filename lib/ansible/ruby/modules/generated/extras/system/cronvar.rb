  ...
  module Ruby
    module Modules
      class Cronvar < Base
        ...
        # @return [Object, nil] If set, create a backup of the crontab before it is modified. The location of the backup is returned in the C(backup) variable by this module.
        attribute :backup
      end
    end
  end
