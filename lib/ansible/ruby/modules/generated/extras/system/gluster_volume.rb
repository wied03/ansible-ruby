  ...
  module Ruby
    module Modules
      class Gluster_volume < Base
        ...
        # @return [Array<String>, nil] Brick paths on servers. Multiple brick paths can be separated by commas
        ...
        # @return [String, nil] A dictionary/hash with options/settings for the volume
        attribute :options
