  ...
  module Ruby
    module Modules
      ...
      class Udm_group < Base
        ...
        # @return [String, nil] define the whole ldap position of the group, e.g. C(cn=g123m-1A,cn=classes,cn=schueler,cn=groups,ou=schule,dc=example,dc=com).
        attribute :position
        ...
        # @return [String, nil] Subpath inside the OU, e.g. C(cn=classes,cn=students,cn=groups).
        attribute :subpath
