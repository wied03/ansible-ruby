  ...
  module Ruby
    module Modules
      class Gitlab_project < Base
        ...
        # @return [TrueClass, nil] Whether you want to create issues or not.,Possible values are true and false.
        attribute :issues_enabled
        validates :issues_enabled, type: TrueClass

        # @return [TrueClass, nil] If merge requests can be made or not.,Possible values are true and false.
        attribute :merge_requests_enabled
        validates :merge_requests_enabled, type: TrueClass

        # @return [TrueClass, nil] If an wiki for this project should be available or not.,Possible values are true and false.
        attribute :wiki_enabled
        validates :wiki_enabled, type: TrueClass

        # @return [TrueClass, nil] If creating snippets should be available or not.,Possible values are true and false.
        attribute :snippets_enabled
        validates :snippets_enabled, type: TrueClass

        # @return [Object, nil] If the project is public available or not.,Setting this to true is same as setting visibility_level to 20.,Possible values are true and false.
        attribute :public
        ...
        # @return [String, nil] Git repository which will me imported into gitlab.,Gitlab server needs read access to this git repository.
