  ...
  module Ruby
    module Modules
      class Consul < Base
        ...
        # @return [String, nil] Notes to attach to check when registering it.
        attribute :notes
        ...
        # @return [String, nil] a list of tags that will be attached to the service registration.
        attribute :tags
        ...
        # @return [String, nil] A custom HTTP check timeout. The consul default is 10 seconds. Similar to the interval this is a number with a s or m suffix to signify the units of seconds or minutes, e.g. 15s or 1m.
        attribute :timeout
        validates :timeout, type: String

        # @return [String, nil] the token key indentifying an ACL rule set. May be required to register services.
        attribute :token
