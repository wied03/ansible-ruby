  ...
  module Ruby
    module Modules
      class Win_updates < Base
        # @return [Array] A scalar or list of categories to install updates from
        ...
        # @return [String] Controls whether found updates are returned as a list or actually installed.,This module also supports Ansible check mode, which has the same effect as setting state=searched
        attribute :state
