  ...
  module Ruby
    module Modules
      class Win_acl_inheritance < Base
        ...
        # @return [String] Specify whether to enable I(present) or disable I(absent) ACL inheritance
        attribute :state
        ...
        validates :reorganize, inclusion: {:in=>[false, true], :message=>"%{value} needs to be false, true"}, allow_nil: true
      end
    end
  end
end
