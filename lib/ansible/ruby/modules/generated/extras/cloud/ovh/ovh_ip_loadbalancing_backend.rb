  ...
  module Ruby
    module Modules
      ...
      class Ovh_ip_loadbalancing_backend < Base
        ...
        # @return [:present, :absent, nil] Determines wether the backend is to be created/modified or deleted
        attribute :state
        ...
        # @return [Integer, nil] The timeout in seconds used to wait for a task to be completed. Default is 120 seconds.
        attribute :timeout
