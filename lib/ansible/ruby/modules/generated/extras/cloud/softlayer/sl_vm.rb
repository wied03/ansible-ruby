  ...
  module Ruby
    module Modules
      class Sl_vm < Base
        ...
        # @return [TrueClass, nil] Flag to determine if the instance should be hourly billed
        attribute :hourly
        validates :hourly, type: TrueClass

        # @return [Object, nil] Flag to determine if the instance should be private only
        attribute :private

        # @return [Object, nil] Falg to determine if the instance should be deployed in dedicated space
        attribute :dedicated

        # @return [TrueClass, nil] Flag to determine if local disk should be used for the new instance
        ...
        # @return [TrueClass, nil] Flag used to wait for active status before returning
        attribute :wait
