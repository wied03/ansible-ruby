  ...
  module Ruby
    module Modules
      class Ec2_vpc_dhcp_options < Base
        ...
        # @return [String, nil] A list of hosts to set the DNS servers for the VPC to. (Should be a list of IP addresses rather than host names.)
        attribute :dns_servers
        validates :dns_servers, type: String

        # @return [String, nil] List of hosts to advertise as NTP servers for the VPC.
        attribute :ntp_servers
        validates :ntp_servers, type: String

        # @return [String, nil] List of hosts to advertise as NetBIOS servers.
        attribute :netbios_name_servers
        validates :netbios_name_servers, type: String

        # @return [String, nil] NetBIOS node type to advertise in the DHCP options. The AWS recommendation is to use 2 (when using netbios name services) http://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_DHCP_Options.html
