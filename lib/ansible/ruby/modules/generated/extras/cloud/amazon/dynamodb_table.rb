  ...
  module Ruby
    module Modules
      class Dynamodb_table < Base
        ...
        # @return [String] Name of the hash key.,Required when C(state=present).
        ...
        # @return [String] Name of the range key.
