  ...
  module Ruby
    module Modules
      class Route53_facts < Base
        # @return [String] specifies the query action to take
        attribute :query
        ...
        # @return [Object] The type of DNS record
        attribute :type
        ...
        # @return [String] This is used in conjunction with query: hosted_zone. It allows for listing details, counts or tags of various hosted zone details.
        ...
        # @return [String] This is used in conjunction with query: health_check. It allows for listing details, counts or tags of various health check details.
