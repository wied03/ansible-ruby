  ...
  module Ruby
    module Modules
      class Cs_iso < Base
        ...
        # @return [Object, nil] This flag is used for searching existing ISOs. If set to C(true), it will only list ISO ready for deployment e.g. successfully downloaded and installed. Recommended to set it to C(false).
        attribute :is_ready
        ...
        # @return [TrueClass, nil] Register the ISO to be bootable. Only used if C(state) is present.
        attribute :bootable
