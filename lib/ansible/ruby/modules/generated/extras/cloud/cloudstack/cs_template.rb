  ...
  module Ruby
    module Modules
      class Cs_template < Base
        ...
        # @return [Object, nil] This flag is used for searching existing templates.,If set to C(true), it will only list template ready for deployment e.g. successfully downloaded and installed.,Recommended to set it to C(false).
        attribute :is_ready

        # @return [TrueClass, nil] Register the template to be publicly available to all users.,Only used if C(state) is present.
        attribute :is_public
        ...
        # @return [TrueClass, nil] Whether the template should be syned or removed across zones.,Only used if C(state) is present or absent.
        ...
        # @return [Object, nil] true if this template requires HVM.
        attribute :requires_hvm

        # @return [TrueClass, nil] True if the template supports the password reset feature.
        ...
        # @return [Object, nil] True if the template supports the sshkey upload feature.
        attribute :sshkey_enabled

        # @return [Object, nil] True if the template type is routing i.e., if template is used to deploy router.,Only considered if C(url) is used.
        ...
        # @return [Object, nil] True if the template or its derivatives are extractable.
