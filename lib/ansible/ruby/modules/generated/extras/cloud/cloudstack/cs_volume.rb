  ...
  module Ruby
    module Modules
      class Cs_volume < Base
        ...
        # @return [TrueClass, nil] Whether to display the volume to the end user or not.,Allowed to Root Admins only.
        ...
        # @return [Object, nil] Force removal of volume even it is attached to a VM.,Considered on C(state=absnet) only.
        attribute :force

        # @return [Object, nil] Whether to allow to shrink the volume.
        attribute :shrink_ok
