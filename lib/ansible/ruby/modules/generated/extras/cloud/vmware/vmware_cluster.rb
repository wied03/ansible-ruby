  ...
  module Ruby
    module Modules
      class Vmware_cluster < Base
        ...
        # @return [String, nil] If set to True will enable HA when the cluster is created.
        attribute :enable_ha
        validates :enable_ha, type: String

        # @return [String, nil] If set to True will enable DRS when the cluster is created.
        attribute :enable_drs
        validates :enable_drs, type: String

        # @return [String, nil] If set to True will enable vSAN when the cluster is created.
