  ...
  module Ruby
    module Modules
      class Vmware_vm_shell < Base
        ...
        # @return [String, nil] The cluster hosting the VM,Will help speed up search
        attribute :cluster
        ...
        # @return [String, nil] Comma seperated list of envirnoment variable, specified in the guest OS notation
