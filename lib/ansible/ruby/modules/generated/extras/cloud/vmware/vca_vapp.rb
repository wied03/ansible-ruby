  ...
  module Ruby
    module Modules
      class Vca_vapp < Base
        ...
        # @return [String, nil] The name of the network that should be attached to the virtual machine in the vApp.  The virtual network specified must already be created in the vCloud Air VDC.  If the I(state) is not 'absent' then the I(network_name) argument must be provided.
        ...
        # @return [String, nil] The name of the virtual machine instance in the vApp to manage.
        attribute :vm_name
        validates :vm_name, type: String

        # @return [String, nil] The number of vCPUs to configure for the VM in the vApp.   If the I(vm_name) argument is provided, then this becomes a per VM setting otherwise it is applied to all VMs in the vApp.
        attribute :vm_cpus
        validates :vm_cpus, type: String

        # @return [String, nil] The amount of memory in MB to allocate to VMs in the vApp.  If the I(vm_name) argument is provided, then this becomes a per VM setting otherise it is applied to all VMs in the vApp.
        attribute :vm_memory
        ...
        # @return [String, nil] The org to login to for creating vapp, mostly set when the service_type is vdc.
        attribute :org
        ...
        # @return [String, nil] The authentication host to be used when service type  is vcd.
        attribute :host
