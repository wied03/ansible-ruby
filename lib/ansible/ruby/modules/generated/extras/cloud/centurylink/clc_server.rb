  ...
  module Ruby
    module Modules
      class Clc_server < Base
        # @return [Array, nil] The list of additional disks for the server
        ...
        # @return [String, nil] The account alias to provision the servers under.
        attribute :alias
        validates :alias, type: String

        # @return [String, nil] The anti-affinity policy to assign to the server. This is mutually exclusive with 'anti_affinity_policy_name'.
        attribute :anti_affinity_policy_id
        validates :anti_affinity_policy_id, type: String

        # @return [String, nil] The anti-affinity policy to assign to the server. This is mutually exclusive with 'anti_affinity_policy_id'.
        attribute :anti_affinity_policy_name
        validates :anti_affinity_policy_name, type: String

        # @return [String, nil] The alert policy to assign to the server. This is mutually exclusive with 'alert_policy_name'.
        attribute :alert_policy_id
        validates :alert_policy_id, type: String

        # @return [String, nil] The alert policy to assign to the server. This is mutually exclusive with 'alert_policy_id'.
        ...
        # @return [String, nil] The autoscale policy to assign to the server.
        attribute :cpu_autoscale_policy_id
        validates :cpu_autoscale_policy_id, type: String

        # @return [Array, nil] The list of custom fields to set on the server.
        attribute :custom_fields
        validates :custom_fields, type: Array

        # @return [String, nil] The description to set for the server.
        attribute :description
        validates :description, type: String

        # @return [String, nil] Run in idempotent mode.  Will insure that this exact number of servers are running in the provided group, creating and deleting them to reach that count.  Requires count_group to be set.
        ...
        # @return [String, nil] The IP Address for the server. One is assigned if not provided.
        attribute :ip_address
        validates :ip_address, type: String

        # @return [String, nil] The Datacenter to create servers in.
        attribute :location
        ...
        # @return [String, nil] The network UUID on which to create servers.
        attribute :network_id
        validates :network_id, type: String

        # @return [Array, nil] The list of blue print packages to run on the server after its created.
        attribute :packages
        validates :packages, type: Array

        # @return [String, nil] Password for the administrator / root user
        attribute :password
        validates :password, type: String

        # @return [String, nil] Primary DNS used by the server.
        ...
        # @return [Array, nil] A list of ports to allow on the firewall to the servers public ip, if add_public_ip is set to True.
        attribute :public_ip_ports
        validates :public_ip_ports, type: Array

        # @return [String, nil] Secondary DNS used by the server.
        attribute :secondary_dns
        validates :secondary_dns, type: String

        # @return [Array, nil] Required for started, stopped, and absent states. A list of server Ids to insure are started, stopped, or absent.
        attribute :server_ids
        validates :server_ids, type: Array

        # @return [String, nil] The password for the source server if a clone is specified.
        ...
        # @return [String, nil] The time to live for the server in seconds.  The server will be deleted when this time expires.
        attribute :ttl
        ...
        # @return [String, nil] Only required for bare metal servers. Specifies the identifier for the specific configuration type of bare metal server to deploy.
