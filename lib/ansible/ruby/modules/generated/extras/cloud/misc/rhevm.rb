  ...
  module Ruby
    module Modules
      ...
      class Rhevm < Base
        ...
        # @return [Object, nil] The name of the VM.
        attribute :name

        # @return [Object, nil] The rhev/ovirt cluster in which you want you VM to start.
        attribute :cluster
        ...
        # @return [Object, nil] The template to use for the VM.
        attribute :image
        ...
        # @return [Object, nil] This option uses complex arguments and is a list of disks with the options name, size and domain.
        attribute :disks

        # @return [Object, nil] This option uses complex arguments and is a list of interfaces with the options name and vlan.
        attribute :ifaces
        ...
        # @return [Object, nil] The CD you wish to have mounted on the VM when I(state = 'CD').
        attribute :cd_drive
