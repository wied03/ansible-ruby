  ...
  module Ruby
    module Modules
      ...
      class Rocketchat < Base
        # @return [String] The domain for your environment without protocol. (i.e. C(subdomain.domain.com or chat.domain.tld))
        attribute :domain
        ...
        # @return [String, nil] Channel to send the message to. If absent, the message goes to the channel selected for the I(token) specifed during the creation of webhook.
        attribute :channel
