  ...
  module Ruby
    module Modules
      class Bigip_facts < Base
        ...
        # @return [nil] BIG-IP session support; may be useful to avoid concurrency issues in certain circumstances.
        attribute :session
        ...
        # @return [nil] Shell-style glob matching string used to filter fact keys. Not applicable for software and system_info fact categories.
        attribute :filter
