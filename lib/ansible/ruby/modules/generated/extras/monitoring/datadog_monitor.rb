  ...
  module Ruby
    module Modules
      class Datadog_monitor < Base
        ...
        # @return [Object, nil] A boolean indicating whether this monitor will notify when data stops reporting..
        attribute :notify_no_data

        # @return [Array<String>, nil] The number of minutes before a monitor will notify when data stops reporting. Must be at least 2x the monitor timeframe for metric alerts or 2 minutes for service checks.
        ...
        # @return [Object, nil] A boolean indicating whether tagged users will be notified on changes to this monitor.
        attribute :notify_audit

        # @return [Hash, nil] A dictionary of thresholds by status. This option is only available for service checks and metric alerts. Because each of them can have multiple thresholds, we don't define them directly in the query.
