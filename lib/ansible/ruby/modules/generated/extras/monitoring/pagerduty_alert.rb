  ...
  module Ruby
    module Modules
      class Pagerduty_alert < Base
        # @return [Object] PagerDuty unique subdomain.
        attribute :name
        validates :name, presence: true

        # @return [Object] The GUID of one of your "Generic API" services.,This is the "service key" listed on a Generic API's service detail page.
        attribute :service_key
        validates :service_key, presence: true

        # @return [Object] Type of event to be sent.
        attribute :state
        ...
        # @return [Object] The pagerduty API key (readonly access), generated on the pagerduty site.
        attribute :api_key
        ...
        # @return [Object] Identifies the incident to which this I(state) should be applied.,For C(triggered) I(state) - If there's no open (i.e. unresolved) incident with this key, a new one will be created. If there's already an open incident with a matching key, this event will be appended to that incident's log. The event key provides an easy way to "de-dup" problem reports.,For C(acknowledged) or C(resolved) I(state) - This should be the incident_key you received back when the incident was first opened by a trigger event. Acknowledge events referencing resolved or nonexistent incidents will be discarded.
        attribute :incident_key

        # @return [Object] The name of the monitoring client that is triggering this event.
        attribute :client

        # @return [Object] The URL of the monitoring client that is triggering this event.
