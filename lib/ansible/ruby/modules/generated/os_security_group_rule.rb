  ...
  module Ruby
    module Modules
      class Os_security_group_rule < Base
        ...
        # @return [String] Must be IPv4 or IPv6, and addresses represented in CIDR must match the ingress or egress rules. Not all providers support IPv6.
        attribute :ethertype
        validates :ethertype, inclusion: {:in=>[:IPv4, :IPv6], :message=>"%{value} needs to be :IPv4, :IPv6"}, allow_nil: true

        # @return [String] The direction in which the security group rule is applied. Not all providers support egress.
        attribute :direction
