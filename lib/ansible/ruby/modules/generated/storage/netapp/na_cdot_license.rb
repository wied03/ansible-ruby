  ...
  module Ruby
    module Modules
      ...
      class Na_cdot_license < Base
        # @return [:true, :false, nil] Remove licenses that have no controller affiliation in the cluster.
        ...
        # @return [:true, :false, nil] Remove licenses that have expired in the cluster.
