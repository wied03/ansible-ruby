  ...
  module Ruby
    module Modules
      ...
      class Na_cdot_user < Base
        ...
        validates :application, presence: true, inclusion: {:in=>[:console, :http, :ontapi, :rsh, :snmp, :sp, :ssh, :telnet], :message=>"%{value} needs to be :console, :http, :ontapi, :rsh, :snmp, :sp, :ssh, :telnet"}
