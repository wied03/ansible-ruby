  ...
  module Ruby
    module Modules
      class Synchronize < Base
        ...
        # @return [Array<String>, nil] Port number for ssh on the destination host. Prior to ansible 2.0, the ansible_ssh_port inventory var took precedence over this value.
        ...
        # @return [TrueClass, nil] put user@ for the remote paths. If you have a custom ssh config to define the remote user for a host that does not match the inventory user, you should set this parameter to "no".
        ...
        # @return [Object, nil] Tells rsync to keep the partial file which should make a subsequent transfer of the rest of the file much faster.
        attribute :partial

        # @return [Object, nil] Verify destination host key.
