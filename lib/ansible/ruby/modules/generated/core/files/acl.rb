  ...
  module Ruby
    module Modules
      ...
      class Acl < Base
        ...
        # @return [Boolean, nil] if the target is a directory, setting this to yes will make it the default acl for entities created inside the directory. It causes an error if name is a file.
        attribute :default
