  ...
  module Ruby
    module Modules
      class Win_lineinfile < Base
        ...
        # @return [String, nil] Validation to run before copying into place.  Use %s in the command to indicate the current file to validate.,The command is passed securely so shell features like expansion and pipes won't work.
        attribute :validate
