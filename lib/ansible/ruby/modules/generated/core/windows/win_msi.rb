  ...
  module Ruby
    module Modules
      class Win_msi < Base
        ...
        # @return [String] Whether the MSI file should be installed or uninstalled
        attribute :state
        ...
        # @return [String] Specify whether to wait for install or uninstall to complete before continuing.
        attribute :wait
