  ...
  module Ruby
    module Modules
      class Win_feature < Base
        ...
        # @return [Boolean, nil] Adds the corresponding management tools to the specified feature
        ...
        # @return [:" {driveletter}:\\sources\\sxs", :" {IP}\\Share\\sources\\sxs", nil] Specify a source to install the feature from
        attribute :source
