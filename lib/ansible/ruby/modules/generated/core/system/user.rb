  ...
  module Ruby
    module Modules
      class User < Base
        ...
        # @return [Array<String>, String, nil] Puts the user in this comma-delimited list of groups. When set to the empty string ('groups='), the user is removed from all groups except the primary group.
        attribute :groups
