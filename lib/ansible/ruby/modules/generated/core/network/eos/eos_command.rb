  ...
  module Ruby
    module Modules
      class Eos_command < Base
        ...
        # @return [Fixnum] Specifies the number of retries a command should be tried before it is considered failed.  The command is run on the target device every retry and evaluated against the waitfor conditionals
        attribute :retries
