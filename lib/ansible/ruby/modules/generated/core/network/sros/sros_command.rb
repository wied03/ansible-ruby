...
module Ansible
  module Ruby
    module Modules
      ...
      class Sros_command < Base
        # @return [Array<String>, String] List of commands to send to the remote SR OS device over the configured provider. The resulting output from the command is returned. If the I(wait_for) argument is provided, the module is not returned until the condition is satisfied or the number of retries has expired.
        attribute :commands
