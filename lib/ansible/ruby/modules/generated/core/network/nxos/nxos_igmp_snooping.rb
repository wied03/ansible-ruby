  ...
  module Ruby
    module Modules
      ...
      class Nxos_igmp_snooping < Base
        # @return [:true, :false, nil] Enables/disables IGMP snooping on the switch.
        attribute :snooping
        ...
        # @return [:true, :false, nil] Global link-local groups suppression.
        ...
        # @return [:true, :false, nil] Global IGMPv3 Report Suppression and Proxy Reporting.
