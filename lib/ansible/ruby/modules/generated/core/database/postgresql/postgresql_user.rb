  ...
  module Ruby
    module Modules
      class Postgresql_user < Base
        ...
        # @return [Array<String>, nil] PostgreSQL privileges string in the format: C(table:priv1,priv2)
        ...
        # @return [Object, nil] whether the password is stored hashed in the database. boolean. Passwords can be passed already hashed or unhashed, and postgresql ensures the stored password is hashed when encrypted is set.
        attribute :encrypted
