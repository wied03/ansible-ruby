  ...
  module Ruby
    module Modules
      class Vsphere_guest < Base
        ...
        # @return [String, nil] The name of the resource_pool to create the VM in.
        attribute :resource_pool
        validates :resource_pool, type: String

        # @return [String, nil] The name of the cluster to create the VM in. By default this is derived from the host you tell the module to build the guest on.
        attribute :cluster
        ...
        # @return [String, nil] Name of the source template to deploy from
