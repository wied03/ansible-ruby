  ...
  module Ruby
    module Modules
      class Rax_dns_record < Base
        ...
        # @return [TrueClass, nil] Add new records if data doesn't match, instead of updating existing record with matching name. If there are already multiple records with matching name and overwrite=true, this module will fail.
        attribute :overwrite
