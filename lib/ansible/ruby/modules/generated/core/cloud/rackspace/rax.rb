  ...
  module Ruby
    module Modules
      class Rax < Base
        ...
        # @return [Object, nil] Whether the I(boot_volume) or newly created volume from I(image) will be terminated when the server is terminated
        ...
        # @return [Array, nil] The network to attach to the instances. If specified, you must include ALL networks including the public and private interfaces. Can be C(id) or C(label).
        attribute :networks
