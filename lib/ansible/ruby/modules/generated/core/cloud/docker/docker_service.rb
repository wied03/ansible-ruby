  ...
  module Ruby
    module Modules
      class Docker_service < Base
        ...
        # @return [TrueClass, nil] When C(state) is I(present) specify whether or not to include linked services.
        ...
        # @return [Object, nil] Whether or not to check the Docker daemon's hostname against the name provided in the client certificate.
        ...
        # @return [TrueClass, nil] Whether or not to build images before starting containers.,Missing images will always be built.,If an image is present and C(build) is false, the image will not be built.,If an image is present and C(build) is true, the image will be built.
        attribute :build
        ...
        # @return [Object, nil] Use with state I(absent) to remove data volumes.
        attribute :remove_volumes

        # @return [Object, nil] Use with state I(present) to leave the containers in an exited or non-running state.
        attribute :stopped

        # @return [Object, nil] Use with state I(present) to restart all containers.
        attribute :restarted

        # @return [String, nil] Include I(actions) in the return values.
        attribute :debug
