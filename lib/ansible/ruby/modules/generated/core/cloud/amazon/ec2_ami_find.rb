  ...
  module Ruby
    module Modules
      class Ec2_ami_find < Base
        ...
        # @return [Object] Whether or not the image(s) are public.
        attribute :is_public
        ...
        # @return [String] Order in which to sort results.,Only used when the 'sort' parameter is specified.
        ...
        # @return [String] What to do when no results are found.,'success' reports success and returns an empty array,'fail' causes the module to report failure
