  ...
  module Ruby
    module Modules
      class Route53 < Base
        ...
        # @return [String, nil] Whether or not to evaluate an alias target health. Useful for aliases to Elastic Load Balancers.
        attribute :alias_evaluate_target_health
        validates :alias_evaluate_target_health, type: String

        # @return [String, nil] The new value when creating a DNS record.  Multiple comma-spaced values are allowed for non-alias records.  When deleting a record all values for the record must be specified or Route53 will not delete it.
        attribute :value
        ...
        # @return [Object, nil] If set to true, the private zone matching the requested name within the domain will be used if there are both public and private zones. The default is to use the public zone.
        ...
        # @return [TrueClass, nil] Wait until the changes have been replicated to all Amazon Route 53 DNS servers.
        attribute :wait
