  ...
  module Ruby
    module Modules
      class Iam_cert < Base
        ...
        # @return [Object, nil] By default the module will not upload a certificate that is already uploaded into AWS. If set to True, it will upload the certificate as long as the name is unique.
        attribute :dup_ok
