  ...
  module Ruby
    module Modules
      class Ec2_eip < Base
        ...
        # @return [Object, nil] allocate an EIP inside a VPC or not
        attribute :in_vpc

        # @return [Object, nil] Reuse an EIP that is not associated to an instance (when available), instead of allocating a new one.
        attribute :reuse_existing_ip_allowed

        # @return [Object, nil] whether or not to automatically release the EIP when it is disassociated
