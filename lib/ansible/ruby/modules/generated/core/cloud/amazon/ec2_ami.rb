  ...
  module Ruby
    module Modules
      class Ec2_ami < Base
        ...
        # @return [String, nil] The name of the new image to create
        attribute :name
        ...
        # @return [String, nil] create or deregister/delete image
        attribute :state
        validates :state, type: String

        # @return [Object, nil] An optional human-readable string describing the contents and purpose of the AMI.
        ...
        # @return [Array, nil] An optional list of device hashes/dictionaries with custom configurations (same block-device-mapping parameters),Valid properties include: device_name, volume_type, size (in GB), delete_on_termination (boolean), no_device (boolean), snapshot_id, iops (for io1 volume_type)
