  ...
  module Ruby
    module Modules
      class Azure_rm_virtualnetwork < Base
        ...
        # @return [Object, nil] Use with state present to remove any existing address_prefixes.
        attribute :purge_address_prefixes

        # @return [Object, nil] Use with state present to remove existing DNS servers, reverting to default Azure servers. Mutually exclusive with dns_servers.
