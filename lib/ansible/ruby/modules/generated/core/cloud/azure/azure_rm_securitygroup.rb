  ...
  module Ruby
    module Modules
      class Azure_rm_securitygroup < Base
        ...
        # @return [Object, nil] Remove any existing rules not matching those defined in the default_rules parameter.
        attribute :purge_default_rules

        # @return [TrueClass, nil] Remove any existing rules not matching those defined in the rules parameters.
        ...
        # @return [Array, nil] Set of rules shaping traffic flow to or from a subnet or NIC. Each rule is a dictionary.
        attribute :rules
