  ...
  module Ruby
    module Modules
      class Apt < Base
        ...
        # @return [String, nil] If C(update_cache) is specified and the last run is less or equal than I(cache_valid_time) seconds ago, the C(update_cache) gets skipped.
        ...
        # @return [Object, nil] Only install/upgrade a package if it is already installed.
