  ...
  module Ruby
    module Modules
      ...
      class Ufw < Base
        ...
        attribute :state
        validates :state, inclusion: {:in=>[:disabled, :enabled, :reloaded, :reset], :message=>"%{value} needs to be :disabled, :enabled, :reloaded, :reset"}, allow_nil: true
        ...
        attribute :direction
        validates :direction, inclusion: {:in=>[:in, :incoming, :out, :outgoing, :routed], :message=>"%{value} needs to be :in, :incoming, :out, :outgoing, :routed"}, allow_nil: true

        # @return [:low, :medium, :high, :full, Boolean, nil] Toggles logging. Logged packets use the LOG_KERN syslog facility.
        attribute :logging
        validates :logging, inclusion: {:in=>[true, false, :low, :medium, :high, :full], :message=>"%{value} needs to be true, false, :low, :medium, :high, :full"}, allow_nil: true
