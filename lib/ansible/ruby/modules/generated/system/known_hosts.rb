  ...
  module Ruby
    module Modules
      ...
      class Known_hosts < Base
        ...
        # @return [Boolean, nil] Hash the hostname in the known_hosts file
        attribute :hash_host
        validates :hash_host, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
