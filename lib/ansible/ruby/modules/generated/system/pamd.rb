  ...
  module Ruby
    module Modules
      ...
      class Pamd < Base
        ...
        # @return [String, nil] The type to assign to the new rule.
        attribute :new_type
        validates :new_type, type: String

        # @return [String, nil] The control to assign to the new rule.
