  ...
  module Ruby
    module Modules
      ...
      class Authorized_key < Base
        ...
        # @return [String, nil] Follow path symlink instead of replacing it
        attribute :follow
