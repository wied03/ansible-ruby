  ...
  module Ruby
    module Modules
      ...
      class Meta < Base
        ...
        attribute :free_form
        validates :free_form, presence: true, inclusion: {:in=>[:flush_handlers, :refresh_inventory, :noop, :clear_facts, :clear_host_errors, :end_play, :reset_connection], :message=>"%{value} needs to be :flush_handlers, :refresh_inventory, :noop, :clear_facts, :clear_host_errors, :end_play, :reset_connection"}
      end
    end
  end
end
