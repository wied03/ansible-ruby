  ...
  module Ruby
    module Modules
      ...
      class Apt_key < Base
        ...
        # @return [String, nil] If C(no), SSL certificates for the target url will not be validated. This should only be used on personally controlled sites using self-signed certificates.
