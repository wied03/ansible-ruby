  ...
  module Ruby
    module Modules
      ...
      class Pulp_repo < Base
        # @return [Boolean, nil] Whether or not to add the export distributor to new C(rpm) repositories.
        attribute :add_export_distributor
        validates :add_export_distributor, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
        ...
        # @return [Boolean, nil] Make the repo available over HTTP.
        attribute :serve_http
        validates :serve_http, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true

        # @return [Boolean, nil] Make the repo available over HTTPS.
        attribute :serve_https
        validates :serve_https, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
