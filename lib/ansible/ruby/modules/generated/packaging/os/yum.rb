  ...
  module Ruby
    module Modules
      ...
      class Yum < Base
        ...
        # @return [String, nil] Package name to run the equivalent of yum list <package> against.
        attribute :list
        ...
        # @return [:yes, :no, nil] Resolve depsolve problems by removing packages that are causing problems from the trans‐ action.
