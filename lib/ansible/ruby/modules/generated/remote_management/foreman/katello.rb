  ...
  module Ruby
    module Modules
      ...
      class Katello < Base
        ...
        attribute :entity
        validates :entity, presence: true, inclusion: {:in=>[:repository, :manifest, :repository_set, :sync_plan, :content_view, :lifecycle_environment, :activation_key], :message=>"%{value} needs to be :repository, :manifest, :repository_set, :sync_plan, :content_view, :lifecycle_environment, :activation_key"}
        ...
        attribute :action
        validates :action, inclusion: {:in=>[:sync, :publish, :promote], :message=>"%{value} needs to be :sync, :publish, :promote"}, allow_nil: true
