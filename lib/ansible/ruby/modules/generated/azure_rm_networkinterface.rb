  ...
  module Ruby
    module Modules
      class Azure_rm_networkinterface < Base
        ...
        # @return [String] Name of an existing virtual network with which the network interface will be associated. Required when creating a network interface.
        attribute :virtual_network_name
        validates :virtual_network_name, type: String

        # @return [String] Name of an existing subnet within the specified virtual network. Required when creating a network interface
        ...
        # @return [TrueClass] When creating a network interface, if no public IP address name is provided a default public IP address will be created. Set to false, if you do not want a public IP address automatically created.
        attribute :public_ip
        validates :public_ip, type: TrueClass

        # @return [String] Name of an existing public IP address object to associate with the security group.
        ...
        # @return [String] Name of an existing security group with which to associate the network interface. If not provided, a default security group will be created.
        attribute :security_group_name
        validates :security_group_name, type: String

        # @return [Object] When a default security group is created for a Linux host a rule will be added allowing inbound TCP connections to the default SSH port 22, and for a Windows host rules will be added allowing inbound access to RDP ports 3389 and 5986. Override the default ports by providing a list of open ports.
