  ...
  module Ruby
    module Modules
      ...
      class Keycloak_client < Base
        ...
        validates :client_authenticator_type, inclusion: {:in=>[:"client-secret", :"client-jwt"], :message=>"%{value} needs to be :\"client-secret\", :\"client-jwt\""}, allow_nil: true
        ...
        validates :bearer_only, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
        ...
        validates :consent_required, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
        ...
        validates :standard_flow_enabled, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
        ...
        validates :implicit_flow_enabled, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
        ...
        validates :direct_access_grants_enabled, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
        ...
        validates :service_accounts_enabled, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
        ...
        validates :authorization_services_enabled, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
        ...
        validates :public_client, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
        ...
        validates :frontchannel_logout, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
        ...
        validates :use_template_config, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
        ...
        validates :use_template_scope, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
        ...
        validates :use_template_mappers, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
        ...
        validates :surrogate_auth_required, inclusion: {:in=>[true, false], :message=>"%{value} needs to be true, false"}, allow_nil: true
