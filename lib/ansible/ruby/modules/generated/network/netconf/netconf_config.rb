  ...
  module Ruby
    module Modules
      ...
      class Netconf_config < Base
        ...
        attribute :lock
        validates :lock, inclusion: {:in=>[:never, :always, :"if-supported"], :message=>"%{value} needs to be :never, :always, :\"if-supported\""}, allow_nil: true
        ...
        validates :default_operation, inclusion: {:in=>[:merge, :replace, :none], :message=>"%{value} needs to be :merge, :replace, :none"}, allow_nil: true
        ...
        validates :error_option, inclusion: {:in=>[:"stop-on-error", :"continue-on-error", :"rollback-on-error"], :message=>"%{value} needs to be :\"stop-on-error\", :\"continue-on-error\", :\"rollback-on-error\""}, allow_nil: true
