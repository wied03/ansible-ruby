  ...
  module Ruby
    module Modules
      ...
      class Nxos_system < Base
        ...
        # @return [String, nil] Configures the default domain name suffix to be used when referencing this node by its FQDN.  This argument accepts either a list of domain names or a list of dicts that configure the domain name and VRF name.  See examples.
        ...
        # @return [Object, nil] Configures a list of domain name suffixes to search when performing DNS name resolution. This argument accepts either a list of domain names or a list of dicts that configure the domain name and VRF name.  See examples.
        ...
        # @return [Object, nil] Specifies the mtu, must be an integer.
