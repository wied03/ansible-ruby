  ...
  module Ruby
    module Modules
      ...
      class Nxos_mtu < Base
        ...
        # @return [Integer, nil] MTU for a specific interface. Must be an even number between 576 and 9216.
        attribute :mtu
        validates :mtu, type: Integer

        # @return [Integer, nil] System jumbo MTU. Must be an even number between 576 and 9216.
        attribute :sysmtu
