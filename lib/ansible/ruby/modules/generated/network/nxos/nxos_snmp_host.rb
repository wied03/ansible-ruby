  ...
  module Ruby
    module Modules
      ...
      class Nxos_snmp_host < Base
        ...
        attribute :v3
        validates :v3, inclusion: {:in=>[:noauth, :auth, :priv], :message=>"%{value} needs to be :noauth, :auth, :priv"}, allow_nil: true
        ...
        attribute :snmp_type
        validates :snmp_type, inclusion: {:in=>[:trap, :inform], :message=>"%{value} needs to be :trap, :inform"}, allow_nil: true
