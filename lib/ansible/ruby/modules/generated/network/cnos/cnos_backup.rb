  ...
  module Ruby
    module Modules
      ...
      class Cnos_backup < Base
        ...
        # @return [Object] This specifies the full file path where the configuration file will be copied on the remote server. In case the relative path is used as the variable value, the root folder for the user of the server needs to be specified.
        attribute :rcpath
        ...
        # @return [Object] Specify the password for the server relating to the protocol used.
