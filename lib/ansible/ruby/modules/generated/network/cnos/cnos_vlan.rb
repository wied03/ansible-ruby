  ...
  module Ruby
    module Modules
      ...
      class Cnos_vlan < Base
        ...
        attribute :vlanArg1
        validates :vlanArg1, presence: true, expression_inclusion: {:in=>[:"access-map", :dot1q, :filter, :"<1-3999> VLAN ID 1-3999 or range"], :message=>"%{value} needs to be :\"access-map\", :dot1q, :filter, :\"<1-3999> VLAN ID 1-3999 or range\""}
        ...
        attribute :vlanArg2
        validates :vlanArg2, expression_inclusion: {:in=>[:"VLAN Access Map name", :"egress-only", :name, :flood, :state, :ip], :message=>"%{value} needs to be :\"VLAN Access Map name\", :\"egress-only\", :name, :flood, :state, :ip"}, allow_nil: true
        ...
        attribute :vlanArg5
        validates :vlanArg5, expression_inclusion: {:in=>[:"access-list name", :"Slot/chassis number", :"Port Aggregation Number"], :message=>"%{value} needs to be :\"access-list name\", :\"Slot/chassis number\", :\"Port Aggregation Number\""}, allow_nil: true
      end
    end
  end
end
