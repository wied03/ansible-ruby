  ...
  module Ruby
    module Modules
      ...
      class Cnos_bgp < Base
        ...
        attribute :bgpArg1
        validates :bgpArg1, presence: true, expression_inclusion: {:in=>[:"address-family", :bestpath, :bgp, :"cluster-id", :confederation, :"enforce-first-as", :"fast-external-failover", :"graceful-restart", :"graceful-restart-helper", :"log-neighbor-changes", :"maxas-limit", :neighbor, :"router-id", :shutdown, :synchronization, :timers, :vrf], :message=>"%{value} needs to be :\"address-family\", :bestpath, :bgp, :\"cluster-id\", :confederation, :\"enforce-first-as\", :\"fast-external-failover\", :\"graceful-restart\", :\"graceful-restart-helper\", :\"log-neighbor-changes\", :\"maxas-limit\", :neighbor, :\"router-id\", :shutdown, :synchronization, :timers, :vrf"}
        ...
        attribute :bgpArg3
        validates :bgpArg3, expression_inclusion: {:in=>[:"aggregate-address", :"client-to-client", :dampening, :distance, :"maximum-paths", :network, :nexthop, :redistribute, :save, :synchronization, :"ignore or multipath-relax", :"confed or missing-as-worst or non-deterministic or remove-recv-med or remove-send-med"], :message=>"%{value} needs to be :\"aggregate-address\", :\"client-to-client\", :dampening, :distance, :\"maximum-paths\", :network, :nexthop, :redistribute, :save, :synchronization, :\"ignore or multipath-relax\", :\"confed or missing-as-worst or non-deterministic or remove-recv-med or remove-send-med\""}, allow_nil: true

        # @return [:"Aggregate prefix", :"Reachability Half-life time", :"route-map", :"Distance for routes ext", :"ebgp or ibgp", :"IP prefix <network>", :"IP prefix <network>/<length>", :synchronization, :"Delay value", :direct, :ospf, :static, :memory, nil] This is an overloaded bgp fourth argument. Usage of this argument can be found is the User Guide referenced above.
        attribute :bgpArg4
        validates :bgpArg4, expression_inclusion: {:in=>[:"Aggregate prefix", :"Reachability Half-life time", :"route-map", :"Distance for routes ext", :"ebgp or ibgp", :"IP prefix <network>", :"IP prefix <network>/<length>", :synchronization, :"Delay value", :direct, :ospf, :static, :memory], :message=>"%{value} needs to be :\"Aggregate prefix\", :\"Reachability Half-life time\", :\"route-map\", :\"Distance for routes ext\", :\"ebgp or ibgp\", :\"IP prefix <network>\", :\"IP prefix <network>/<length>\", :synchronization, :\"Delay value\", :direct, :ospf, :static, :memory"}, allow_nil: true
        ...
        attribute :bgpArg5
        validates :bgpArg5, expression_inclusion: {:in=>[:"as-set", :"summary-only", :"Value to start reusing a route", :"Distance for routes internal", :"Supported multipath numbers", :backdoor, :map, :"route-map"], :message=>"%{value} needs to be :\"as-set\", :\"summary-only\", :\"Value to start reusing a route\", :\"Distance for routes internal\", :\"Supported multipath numbers\", :backdoor, :map, :\"route-map\""}, allow_nil: true

        # @return [:"summary-only", :"as-set", :"route-map name", :"Value to start suppressing a route", :"Distance local routes", :"Network mask", :"Pointer to route-map entries", nil] This is an overloaded bgp sixth argument. Usage of this argument can be found is the User Guide referenced above.
        attribute :bgpArg6
        validates :bgpArg6, expression_inclusion: {:in=>[:"summary-only", :"as-set", :"route-map name", :"Value to start suppressing a route", :"Distance local routes", :"Network mask", :"Pointer to route-map entries"], :message=>"%{value} needs to be :\"summary-only\", :\"as-set\", :\"route-map name\", :\"Value to start suppressing a route\", :\"Distance local routes\", :\"Network mask\", :\"Pointer to route-map entries\""}, allow_nil: true

        # @return [:"Maximum duration to suppress a stable route(minutes)", :backdoor, :"route-map", :"Name of the route map", nil] This is an overloaded bgp seventh argument. Use of this argument can be found is the User Guide referenced above.
        attribute :bgpArg7
        validates :bgpArg7, expression_inclusion: {:in=>[:"Maximum duration to suppress a stable route(minutes)", :backdoor, :"route-map", :"Name of the route map"], :message=>"%{value} needs to be :\"Maximum duration to suppress a stable route(minutes)\", :backdoor, :\"route-map\", :\"Name of the route map\""}, allow_nil: true
        ...
        attribute :bgpArg8
        validates :bgpArg8, expression_inclusion: {:in=>[:"Un-reachability Half-life time for the penalty(minutes)", :backdoor], :message=>"%{value} needs to be :\"Un-reachability Half-life time for the penalty(minutes)\", :backdoor"}, allow_nil: true
      end
    end
  end
end
