  ...
  module Ruby
    module Modules
      ...
      class Cnos_bgp < Base
        ...
        attribute :bgpArg6
        validates :bgpArg6, inclusion: {:in=>[:"summary-only", :"as-set", :"route-map name", :"Value to start suppressing a route", :"Distance local routes", :"Network mask", :"Pointer to route-map entries"], :message=>"%{value} needs to be :\"summary-only\", :\"as-set\", :\"route-map name\", :\"Value to start suppressing a route\", :\"Distance local routes\", :\"Network mask\", :\"Pointer to route-map entries\""}, allow_nil: true
