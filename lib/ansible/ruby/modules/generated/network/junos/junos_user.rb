  ...
  module Ruby
    module Modules
      ...
      class Junos_user < Base
        ...
        attribute :role
        validates :role, inclusion: {:in=>[:operator, :"read-only", :"super-user", :unauthorized], :message=>"%{value} needs to be :operator, :\"read-only\", :\"super-user\", :unauthorized"}, allow_nil: true
