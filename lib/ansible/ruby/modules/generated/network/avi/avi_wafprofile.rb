  ...
  module Ruby
    module Modules
      ...
      class Avi_wafprofile < Base
        ...
        # @return [Object] Config params for waf.,Field introduced in 17.2.1.
        attribute :config
        ...
        # @return [Object, nil] List of data files used for waf rules.,Field introduced in 17.2.1.
        attribute :files
