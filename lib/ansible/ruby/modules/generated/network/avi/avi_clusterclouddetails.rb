...
module Ansible
  module Ruby
    module Modules
      ...
      class Avi_clusterclouddetails < Base
        ...
        # @return [Object, nil] Azure info to configure cluster_vip on the controller.,Field introduced in 17.2.5.
        attribute :azure_info

        # @return [String] Field introduced in 17.2.5.
        attribute :name
        validates :name, presence: true, type: String

        # @return [Object, nil] It is a reference to an object of type tenant.,Field introduced in 17.2.5.
        attribute :tenant_ref

        # @return [Object, nil] Avi controller URL of the object.
        attribute :url

        # @return [Object, nil] Field introduced in 17.2.5.
        attribute :uuid
      end
    end
  end
