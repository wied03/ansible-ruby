...
module Ansible
  module Ruby
    module Modules
      ...
      class Avi_autoscalelaunchconfig < Base
        ...
        # @return [String, nil] Unique id of the amazon machine image (ami)  or openstack vm id.
        attribute :image_id
        validates :image_id, type: String

        # @return [Object, nil] Autoscalemesossettings settings for autoscalelaunchconfig.
        attribute :mesos
        ...
        # @return [Object, nil] Autoscaleopenstacksettings settings for autoscalelaunchconfig.
        attribute :openstack
