  ...
  module Ruby
    module Modules
      ...
      class Avi_dnspolicy < Base
        ...
        # @return [Object, nil] Creator name.,Field introduced in 17.1.1.
        attribute :created_by

        # @return [Object, nil] Field introduced in 17.1.1.
        attribute :description

        # @return [String] Name of the dns policy.,Field introduced in 17.1.1.
        attribute :name
        validates :name, presence: true, type: String

        # @return [Object, nil] Dns rules.,Field introduced in 17.1.1.
        attribute :rule
        ...
        # @return [Object, nil] Uuid of the dns policy.,Field introduced in 17.1.1.
        attribute :uuid
      end
    end
  end
