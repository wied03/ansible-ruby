...
module Ansible
  module Ruby
    module Modules
      ...
      class Avi_cloudproperties < Base
        ...
        # @return [Object, nil] Cloudconnector properties.
        attribute :cc_props

        # @return [Object, nil] Cloud types supported by cloudconnector.,Enum options - CLOUD_NONE, CLOUD_VCENTER, CLOUD_OPENSTACK, CLOUD_AWS, CLOUD_VCA, CLOUD_APIC, CLOUD_MESOS, CLOUD_LINUXSERVER, CLOUD_DOCKER_UCP,,CLOUD_RANCHER, CLOUD_OSHIFT_K8S, CLOUD_AZURE.
        attribute :cc_vtypes

        # @return [Object, nil] Hypervisor properties.
        attribute :hyp_props

        # @return [Object, nil] Properties specific to a cloud type.
        attribute :info
