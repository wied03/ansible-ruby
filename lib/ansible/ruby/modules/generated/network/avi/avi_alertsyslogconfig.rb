...
module Ansible
  module Ruby
    module Modules
      ...
      class Avi_alertsyslogconfig < Base
        ...
        # @return [Object, nil] User defined description for alert syslog config.
        attribute :description

        # @return [String] A user-friendly name of the syslog notification.
        attribute :name
        validates :name, presence: true, type: String

        # @return [Array<Hash>, Hash, nil] The list of syslog servers.
        attribute :syslog_servers
        validates :syslog_servers, type: TypeGeneric.new(Hash)
