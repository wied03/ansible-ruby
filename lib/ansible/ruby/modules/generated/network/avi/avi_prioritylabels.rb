  ...
  module Ruby
    module Modules
      ...
      class Avi_prioritylabels < Base
        ...
        # @return [Object, nil] A description of the priority labels.
        attribute :description

        # @return [Object, nil] Equivalent priority labels in descending order.
        attribute :equivalent_labels

        # @return [String] The name of the priority labels.
        attribute :name
        ...
        # @return [Object, nil] Uuid of the priority labels.
        attribute :uuid
      end
    end
  end
