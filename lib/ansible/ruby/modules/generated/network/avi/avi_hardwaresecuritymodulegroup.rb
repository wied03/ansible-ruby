...
module Ansible
  module Ruby
    module Modules
      ...
      class Avi_hardwaresecuritymodulegroup < Base
        ...
        # @return [Object] Hardware security module configuration.
        attribute :hsm
        validates :hsm, presence: true

        # @return [String] Name of the hsm group configuration object.
        attribute :name
        ...
        # @return [Object, nil] Uuid of the hsm group configuration object.
        attribute :uuid
      end
    end
  end
