...
module Ansible
  module Ruby
    module Modules
      ...
      class Avi_snmptrapprofile < Base
        ...
        # @return [String] A user-friendly name of the snmp trap configuration.
        attribute :name
        ...
        # @return [Object, nil] The ip address or hostname of the snmp trap destination server.
        attribute :trap_servers

        # @return [Object, nil] Avi controller URL of the object.
        attribute :url

        # @return [Object, nil] Uuid of the snmp trap profile object.
        attribute :uuid
      end
    end
  end
