  ...
  module Ruby
    module Modules
      ...
      class Aci_domain < Base
        ...
        validates :encap_mode, inclusion: {:in=>[:unknown, :vlan, :vxlan], :message=>"%{value} needs to be :unknown, :vlan, :vxlan"}, allow_nil: true
        ...
        attribute :vswitch
        validates :vswitch, inclusion: {:in=>[:avs, :default, :dvs, :unknown], :message=>"%{value} needs to be :avs, :default, :dvs, :unknown"}, allow_nil: true
      end
    end
  end
end
