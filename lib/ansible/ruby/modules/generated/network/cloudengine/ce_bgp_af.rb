  ...
  module Ruby
    module Modules
      ...
      class Ce_bgp_af < Base
        ...
        validates :ibgp_ecmp_nexthop_changed, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :ebgp_ecmp_nexthop_changed, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :ecmp_nexthop_changed, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :default_rt_import_enable, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :nexthop_third_party, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :summary_automatic, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :auto_frr_enable, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true

        # @return [:no_use, :true, :false, nil] Load balancing as path ignore.
        attribute :load_balancing_as_path_ignore
        validates :load_balancing_as_path_ignore, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :rib_only_enable, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :active_route_advertise, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :as_path_neglect, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :med_none_as_maximum, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :router_id_neglect, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :igp_metric_ignore, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :always_compare_med, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :determin_med, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :reflect_between_client, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :policy_vpn_target, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true

        # @return [:default, :dependTunnel, :dependIp, nil] Next hop select depend type.
        attribute :next_hop_sel_depend_type
        validates :next_hop_sel_depend_type, inclusion: {:in=>[:default, :dependTunnel, :dependIp], :message=>"%{value} needs to be :default, :dependTunnel, :dependIp"}, allow_nil: true
        ...
        validates :reflect_chg_path, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :allow_invalid_as, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :policy_ext_comm_enable, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :supernet_uni_adv, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :supernet_label_adv, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :originator_prior, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :lowest_priority, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :relay_delay_enable, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :import_protocol, inclusion: {:in=>[:direct, :ospf, :isis, :static, :rip, :ospfv3, :ripng], :message=>"%{value} needs to be :direct, :ospf, :isis, :static, :rip, :ospfv3, :ripng"}, allow_nil: true
