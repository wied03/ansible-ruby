  ...
  module Ruby
    module Modules
      ...
      class Ce_info_center_log < Base
        ...
        validates :log_time_stamp, inclusion: {:in=>[:date_boot, :date_second, :date_tenthsecond, :date_millisecond, :shortdate_second, :shortdate_tenthsecond, :shortdate_millisecond, :formatdate_second, :formatdate_tenthsecond, :formatdate_millisecond], :message=>"%{value} needs to be :date_boot, :date_second, :date_tenthsecond, :date_millisecond, :shortdate_second, :shortdate_tenthsecond, :shortdate_millisecond, :formatdate_second, :formatdate_tenthsecond, :formatdate_millisecond"}, allow_nil: true

        # @return [:no_use, :true, :false, nil] Enables the Switch to send logs to the log buffer.
        attribute :log_buff_enable
        validates :log_buff_enable, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :log_enable, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true

        # @return [:emergencies, :alert, :critical, :error, :warning, :notification, :informational, :debugging, nil] Specifies a log severity.
        attribute :log_level
        validates :log_level, inclusion: {:in=>[:emergencies, :alert, :critical, :error, :warning, :notification, :informational, :debugging], :message=>"%{value} needs to be :emergencies, :alert, :critical, :error, :warning, :notification, :informational, :debugging"}, allow_nil: true
