  ...
  module Ruby
    module Modules
      ...
      class Ce_info_center_debug < Base
        ...
        validates :debug_time_stamp, inclusion: {:in=>[:date_boot, :date_second, :date_tenthsecond, :date_millisecond, :shortdate_second, :shortdate_tenthsecond, :shortdate_millisecond, :formatdate_second, :formatdate_tenthsecond, :formatdate_millisecond], :message=>"%{value} needs to be :date_boot, :date_second, :date_tenthsecond, :date_millisecond, :shortdate_second, :shortdate_tenthsecond, :shortdate_millisecond, :formatdate_second, :formatdate_tenthsecond, :formatdate_millisecond"}, allow_nil: true
        ...
        validates :debug_enable, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :debug_level, inclusion: {:in=>[:emergencies, :alert, :critical, :error, :warning, :notification, :informational, :debugging], :message=>"%{value} needs to be :emergencies, :alert, :critical, :error, :warning, :notification, :informational, :debugging"}, allow_nil: true
      end
    end
  end
end
