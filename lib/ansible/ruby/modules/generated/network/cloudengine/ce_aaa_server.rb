  ...
  module Ruby
    module Modules
      ...
      class Ce_aaa_server < Base
        ...
        validates :first_authen_mode, inclusion: {:in=>[:invalid, :local, :hwtacacs, :radius, :none], :message=>"%{value} needs to be :invalid, :local, :hwtacacs, :radius, :none"}, allow_nil: true
        ...
        validates :first_author_mode, inclusion: {:in=>[:invalid, :local, :hwtacacs, :"if-authenticated", :none], :message=>"%{value} needs to be :invalid, :local, :hwtacacs, :\"if-authenticated\", :none"}, allow_nil: true
        ...
        validates :accounting_mode, inclusion: {:in=>[:invalid, :hwtacacs, :radius, :none], :message=>"%{value} needs to be :invalid, :hwtacacs, :radius, :none"}, allow_nil: true
