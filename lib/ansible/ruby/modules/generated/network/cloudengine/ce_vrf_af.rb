  ...
  module Ruby
    module Modules
      ...
      class Ce_vrf_af < Base
        ...
        validates :vrf_aftype, inclusion: {:in=>[:v4, :v6], :message=>"%{value} needs to be :v4, :v6"}, allow_nil: true
        ...
        validates :vpn_target_state, inclusion: {:in=>[:present, :absent], :message=>"%{value} needs to be :present, :absent"}, allow_nil: true

        # @return [:export_extcommunity, :import_extcommunity, nil] VPN instance vpn target type.
        attribute :vpn_target_type
        validates :vpn_target_type, inclusion: {:in=>[:export_extcommunity, :import_extcommunity], :message=>"%{value} needs to be :export_extcommunity, :import_extcommunity"}, allow_nil: true
