  ...
  module Ruby
    module Modules
      ...
      class Ce_bgp_neighbor_af < Base
        ...
        attribute :af_type
        validates :af_type, presence: true, inclusion: {:in=>[:ipv4uni, :ipv4multi, :ipv4vpn, :ipv6uni, :ipv6vpn, :evpn], :message=>"%{value} needs to be :ipv4uni, :ipv4multi, :ipv4vpn, :ipv6uni, :ipv6vpn, :evpn"}
        ...
        validates :advertise_irb, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :advertise_arp, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :advertise_remote_nexthop, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :advertise_community, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :advertise_ext_community, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :discard_ext_community, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :allow_as_loop_enable, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :nexthop_configure, inclusion: {:in=>[:null, :local, :invariable], :message=>"%{value} needs to be :null, :local, :invariable"}, allow_nil: true
        ...
        validates :public_as_only, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true

        # @return [:no_use, :true, :false, nil] If the value is true, sent BGP update messages carry only the public AS number but do not carry private AS numbers. If the value is false, sent BGP update messages can carry private AS numbers.
        attribute :public_as_only_force
        validates :public_as_only_force, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true

        # @return [:no_use, :true, :false, nil] Limited use public as number.
        attribute :public_as_only_limited
        validates :public_as_only_limited, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true

        # @return [:no_use, :true, :false, nil] Private as replaced by public as number.
        attribute :public_as_only_replace
        validates :public_as_only_replace, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true

        # @return [:no_use, :true, :false, nil] Public as only skip peer as.
        attribute :public_as_only_skip_peer_as
        validates :public_as_only_skip_peer_as, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :route_limit_type, inclusion: {:in=>[:noparameter, :alertOnly, :idleForever, :idleTimeout], :message=>"%{value} needs to be :noparameter, :alertOnly, :idleForever, :idleTimeout"}, allow_nil: true
        ...
        validates :redirect_ip, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true

        # @return [:no_use, :true, :false, nil] Redirect ip vaildation.
        attribute :redirect_ip_vaildation
        validates :redirect_ip_vaildation, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :reflect_client, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :substitute_as_enable, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :ipprefix_orf_enable, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :is_nonstd_ipprefix_mod, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        attribute :orf_mode
        validates :orf_mode, inclusion: {:in=>[:null, :receive, :send, :both], :message=>"%{value} needs to be :null, :receive, :send, :both"}, allow_nil: true
        ...
        validates :default_rt_adv_enable, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :default_rt_match_mode, inclusion: {:in=>[:null, :matchall, :matchany], :message=>"%{value} needs to be :null, :matchall, :matchany"}, allow_nil: true
        ...
        validates :add_path_mode, inclusion: {:in=>[:null, :receive, :send, :both], :message=>"%{value} needs to be :null, :receive, :send, :both"}, allow_nil: true
        ...
        validates :origin_as_valid, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true

        # @return [:no_use, :true, :false, nil] If the value is true, vpls enable. If the value is false, vpls disable.
        attribute :vpls_enable
        validates :vpls_enable, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :vpls_ad_disable, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
        ...
        validates :update_pkt_standard_compatible, inclusion: {:in=>[:no_use, :true, :false], :message=>"%{value} needs to be :no_use, :true, :false"}, allow_nil: true
      end
    end
  end
end
