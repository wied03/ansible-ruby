  ...
  module Ruby
    module Modules
      ...
      class Ce_netstream_template < Base
        ...
        attribute :match
        validates :match, inclusion: {:in=>[:"destination-address", :"destination-port", :tos, :protocol, :"source-address", :"source-port"], :message=>"%{value} needs to be :\"destination-address\", :\"destination-port\", :tos, :protocol, :\"source-address\", :\"source-port\""}, allow_nil: true
        ...
        validates :collect_counter, inclusion: {:in=>[:bytes, :packets], :message=>"%{value} needs to be :bytes, :packets"}, allow_nil: true
        ...
        validates :collect_interface, inclusion: {:in=>[:input, :output], :message=>"%{value} needs to be :input, :output"}, allow_nil: true
