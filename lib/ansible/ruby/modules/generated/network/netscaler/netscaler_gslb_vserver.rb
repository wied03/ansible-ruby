  ...
  module Ruby
    module Modules
      ...
      class Netscaler_gslb_vserver < Base
        ...
        validates :dnsrecordtype, expression_inclusion: {:in=>[:A, :AAAA, :CNAME, :NAPTR], :message=>"%{value} needs to be :A, :AAAA, :CNAME, :NAPTR"}, allow_nil: true
        ...
        validates :backuplbmethod, expression_inclusion: {:in=>[:ROUNDROBIN, :LEASTCONNECTION, :LEASTRESPONSETIME, :SOURCEIPHASH, :LEASTBANDWIDTH, :LEASTPACKETS, :STATICPROXIMITY, :RTT, :CUSTOMLOAD], :message=>"%{value} needs to be :ROUNDROBIN, :LEASTCONNECTION, :LEASTRESPONSETIME, :SOURCEIPHASH, :LEASTBANDWIDTH, :LEASTPACKETS, :STATICPROXIMITY, :RTT, :CUSTOMLOAD"}, allow_nil: true
        ...
        validates :persistencetype, expression_inclusion: {:in=>[:SOURCEIP, :NONE], :message=>"%{value} needs to be :SOURCEIP, :NONE"}, allow_nil: true
        ...
        attribute :mir
        validates :mir, expression_inclusion: {:in=>[:enabled, :disabled], :message=>"%{value} needs to be :enabled, :disabled"}, allow_nil: true
        ...
        validates :dynamicweight, expression_inclusion: {:in=>[:SERVICECOUNT, :SERVICEWEIGHT, :DISABLED], :message=>"%{value} needs to be :SERVICECOUNT, :SERVICEWEIGHT, :DISABLED"}, allow_nil: true
        ...
        validates :considereffectivestate, expression_inclusion: {:in=>[:NONE, :STATE_ONLY], :message=>"%{value} needs to be :NONE, :STATE_ONLY"}, allow_nil: true
