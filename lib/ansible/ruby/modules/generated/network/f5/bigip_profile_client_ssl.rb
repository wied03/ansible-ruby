  ...
  module Ruby
    module Modules
      ...
      class Bigip_profile_client_ssl < Base
        ...
        validates :secure_renegotiation, expression_inclusion: {:in=>[:require, :"require-strict", :request], :message=>"%{value} needs to be :require, :\"require-strict\", :request"}, allow_nil: true
