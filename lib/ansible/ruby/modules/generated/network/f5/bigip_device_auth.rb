  ...
  module Ruby
    module Modules
      ...
      class Bigip_device_auth < Base
        ...
        attribute :type
        validates :type, expression_inclusion: {:in=>[:tacacs, :local], :message=>"%{value} needs to be :tacacs, :local"}, allow_nil: true
        ...
        validates :service_name, expression_inclusion: {:in=>[:slip, :ppp, :arap, :shell, :"tty-daemon", :connection, :system, :firewall], :message=>"%{value} needs to be :slip, :ppp, :arap, :shell, :\"tty-daemon\", :connection, :system, :firewall"}, allow_nil: true
        ...
        validates :protocol_name, expression_inclusion: {:in=>[:lcp, :ip, :ipx, :atalk, :vines, :lat, :xremote, :tn3270, :telnet, :rlogin, :pad, :vpdn, :ftp, :http, :deccp, :osicp, :unknown], :message=>"%{value} needs to be :lcp, :ip, :ipx, :atalk, :vines, :lat, :xremote, :tn3270, :telnet, :rlogin, :pad, :vpdn, :ftp, :http, :deccp, :osicp, :unknown"}, allow_nil: true
        ...
        validates :authentication, expression_inclusion: {:in=>[:"use-first-server", :"use-all-servers"], :message=>"%{value} needs to be :\"use-first-server\", :\"use-all-servers\""}, allow_nil: true
        ...
        validates :update_secret, expression_inclusion: {:in=>[:always, :on_create], :message=>"%{value} needs to be :always, :on_create"}, allow_nil: true
      end
    end
  end
end
