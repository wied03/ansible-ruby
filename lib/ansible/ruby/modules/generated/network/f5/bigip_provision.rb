  ...
  module Ruby
    module Modules
      ...
      class Bigip_provision < Base
        ...
        attribute :module
        validates :module, presence: true, inclusion: {:in=>[:am, :afm, :apm, :asm, :avr, :cgnat, :fps, :gtm, :ilx, :lc, :ltm, :pem, :sam, :swg, :vcmp], :message=>"%{value} needs to be :am, :afm, :apm, :asm, :avr, :cgnat, :fps, :gtm, :ilx, :lc, :ltm, :pem, :sam, :swg, :vcmp"}
        ...
        attribute :level
        validates :level, inclusion: {:in=>[:dedicated, :nominal, :minimum], :message=>"%{value} needs to be :dedicated, :nominal, :minimum"}, allow_nil: true
