...
module Ansible
  module Ruby
    module Modules
      ...
      class Bigiq_application_https_waf < Base
        ...
        # @return [String, nil] Specifies the name of service environment that the application will be deployed to.,When creating a new application, this parameter is required.
