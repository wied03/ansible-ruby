  ...
  module Ruby
    module Modules
      ...
      class Bigip_trunk < Base
        ...
        validates :link_selection_policy, expression_inclusion: {:in=>[:auto, :"maximum-bandwidth"], :message=>"%{value} needs to be :auto, :\"maximum-bandwidth\""}, allow_nil: true
        ...
        validates :frame_distribution_hash, expression_inclusion: {:in=>[:"destination-mac", :"source-destination-ip", :"source-destination-mac"], :message=>"%{value} needs to be :\"destination-mac\", :\"source-destination-ip\", :\"source-destination-mac\""}, allow_nil: true
        ...
        attribute :lacp_mode
        validates :lacp_mode, expression_inclusion: {:in=>[:active, :passive], :message=>"%{value} needs to be :active, :passive"}, allow_nil: true
        ...
        validates :lacp_timeout, expression_inclusion: {:in=>[:long, :short], :message=>"%{value} needs to be :long, :short"}, allow_nil: true
