  ...
  module Ruby
    module Modules
      ...
      class Bigip_virtual_server < Base
        ...
        attribute :type
        validates :type, expression_inclusion: {:in=>[:standard, :"forwarding-l2", :"forwarding-ip", :"performance-http", :"performance-l4", :stateless, :reject, :dhcp, :internal, :"message-routing"], :message=>"%{value} needs to be :standard, :\"forwarding-l2\", :\"forwarding-ip\", :\"performance-http\", :\"performance-l4\", :stateless, :reject, :dhcp, :internal, :\"message-routing\""}, allow_nil: true
        ...
        validates :ip_protocol, expression_inclusion: {:in=>[:ah, :bna, :esp, :etherip, :gre, :icmp, :ipencap, :ipv6, :"ipv6-auth", :"ipv6-crypt", :"ipv6-icmp", :"isp-ip", :mux, :ospf, :sctp, :tcp, :udp, :udplite], :message=>"%{value} needs to be :ah, :bna, :esp, :etherip, :gre, :icmp, :ipencap, :ipv6, :\"ipv6-auth\", :\"ipv6-crypt\", :\"ipv6-icmp\", :\"isp-ip\", :mux, :ospf, :sctp, :tcp, :udp, :udplite"}, allow_nil: true
