  ...
  module Ruby
    module Modules
      ...
      class Bigip_vcmp_guest < Base
        ...
        attribute :state
        validates :state, inclusion: {:in=>[:configured, :disabled, :provisioned, :present, :absent], :message=>"%{value} needs to be :configured, :disabled, :provisioned, :present, :absent"}, allow_nil: true
