  ...
  module Ruby
    module Modules
      ...
      class Bigip_monitor_http < Base
        ...
        # @return [String, nil] Specifies the user name, if the monitored target requires authentication.
        attribute :target_username
        validates :target_username, type: String

        # @return [String, nil] Specifies the password, if the monitored target requires authentication.
        attribute :target_password
        validates :target_password, type: String
