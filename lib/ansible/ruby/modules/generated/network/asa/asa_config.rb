  ...
  module Ruby
    module Modules
      ...
      class Asa_config < Base
        ...
        # @return [String, nil] This argument specifies to include passwords in the config when retrieving the running-config from the remote device.  This includes passwords related to VPN endpoints.  This argument is mutually exclusive with I(defaults).
        attribute :passwords
        validates :passwords, type: String

        # @return [String, nil] The C(save) argument instructs the module to save the running- config to the startup-config at the conclusion of the module running.  If check mode is specified, this argument is ignored.
        attribute :save
