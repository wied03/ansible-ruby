...
module Ansible
  module Ruby
    module Modules
      ...
      class Onyx_command < Base
        # @return [Array<String>, String] List of commands to send to the remote Mellanox ONYX network device. The resulting output from the command is returned. If the I(wait_for) argument is provided, the module is not returned until the condition is satisfied or the number of retries has expired.
        attribute :commands
