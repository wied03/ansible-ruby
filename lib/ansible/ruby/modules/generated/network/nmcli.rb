  ...
  module Ruby
    module Modules
      ...
      class Nmcli < Base
        ...
        # @return [Array<String>, String, nil] A list of upto 3 dns servers, ipv4 format e.g. To add two IPv4 DNS server addresses: ["192.0.2.53", "198.51.100.53"]
        attribute :dns4
        validates :dns4, type: TypeGeneric.new(String)
