  ...
  module Ruby
    module Modules
      ...
      class Aireos_config < Base
        ...
        attribute :save_when
        validates :save_when, inclusion: {:in=>[:always, :never, :changed], :message=>"%{value} needs to be :always, :never, :changed"}, allow_nil: true
        ...
        validates :diff_against, inclusion: {:in=>[:intended, :running], :message=>"%{value} needs to be :intended, :running"}, allow_nil: true
