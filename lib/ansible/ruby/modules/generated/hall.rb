  ...
  module Ruby
    module Modules
      class Hall < Base
        ...
        # @return [Object] The full URL to the image you wish to use for the Icon of the message. Defaults to U(http://cdn2.hubspot.net/hub/330046/file-769078210-png/Official_Logos/ansible_logo_black_square_small.png?t=1421076128627)
        attribute :picture
      end
    end
  end
